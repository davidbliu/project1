...
urlpatterns = patterns('',
    ...
    (r'^categories/(?P<which>\d+)/$', 'Rate.views.cat_list'),
    ...
    # (r'^home/$', 'Rate.views.cat_list'),
    (r'^liked/(?P<likeID>\d+)/(?P<cID>\d+)/(?P<pID>\d+)$', 'Rate.views.like_comment_view'),
    (r'^people/$', 'Rate.views.people_view'),
    ...
    (r'^upload/entry/(?P<eID>\d+)/$', 'Rate.views.upload_view'),
    ...
    #from chat app
    (r'^messages/$', 'chat.views.messages_view'),
)
